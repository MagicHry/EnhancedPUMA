...
import hku.cs.reilly.launcher.RYTransition;
...
public class UIState {
	...
	private ArrayList<RYTransition> mTransitions; //the transitions from this state
	...
	public void setmTransitions(ArrayList<RYTransition> mTransitions) {
